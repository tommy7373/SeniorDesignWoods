...
// IMU Default Configs //
/////////////////////////
#define DMP_SAMPLE_RATE    4 // Logging/DMP sample rate(4-200 Hz)
#define IMU_COMPASS_SAMPLE_RATE 4 // Compass sample rate (4-100 Hz)
#define IMU_AG_SAMPLE_RATE 4 // Accel/gyro sample rate Must be between 4Hz and 1kHz
#define IMU_GYRO_FSR       250 // Gyro full-scale range (250, 500, 1000, or 2000 degrees/sec)
#define IMU_ACCEL_FSR      2 // Accel full-scale range (2, 4, 8, or 16 g)
...
//////////////////////////
// Danger - don't change unless using a different board
